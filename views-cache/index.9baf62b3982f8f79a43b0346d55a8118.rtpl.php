...
<div class="product-area">
    <div class="container">
                ...
                <h1 class="my-4">Categorias</h1>
                    <?php $counter1=-1;  if( isset($category) && ( is_array($category) || $category instanceof Traversable ) && sizeof($category) ) foreach( $category as $key1 => $value1 ){ $counter1++; ?>
                        <div class="list-group">
                            <a href="/categories/<?php echo htmlspecialchars( $value1["idcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="list-group-item" alt="/<?php echo htmlspecialchars( $value1["idcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["descategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a>
                        </div>
                    <?php } ?>
            </div>
        ...
        <div class="col-md-10" id="central">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="single-product">
                        <div class="product-f-image">
                            <a href="#"><img src="<?php echo htmlspecialchars( $value1["desphoto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" alt="" width="250"></a>
...
</div><!-- fim do conteudo central do site -->

<!-- inicicio da area do mais vendidos -->
